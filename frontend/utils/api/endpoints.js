...
const endpoints = {
  workspace: {
    ...
    // Keep boards from develop branch (profiles from feature-refactor seem to be the same functionality)
    boards: {
      ...
      delete: (workspaceId, boardId) =>
        `${WORKSPACE_BASE_URL}/${workspaceId}/boards/${boardId}`,
      getProfile: (workspaceId, boardId) =>
        `${WORKSPACE_BASE_URL}/${workspaceId}/boards/${boardId}`,
      getProfiles: (workspaceId) =>
        `${WORKSPACE_BASE_URL}/${workspaceId}/boards`,
    },
    ...
    day_book: {
      ...
      reports: {
        drafts: {
          ...
          getDrafts: (workspaceId) =>
            `${REPORTS_BASE_URL}/drafts?workspaceId=${workspaceId}`,
