...
* lambda:HelloWorldFunction (nodejs22.x)
* API lambda:HelloWorldFunction (nodejs22.x)
* backend:HelloWorldFunction (nodejs22.x)
* API backend:HelloWorldFunction (nodejs22.x)
